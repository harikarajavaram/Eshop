...
<div class='navLeftFooter nav-sprite-v1' id='navFooter'>
        ...
        <tr>
            <td class="navFooterLinkCol">
                ...
                <ul>
                    ...
                    <li><a href="#" class='nav_a'>Tesco Cares</a></li>
            ...
            <td class="navFooterLinkCol">
                ...
                <ul>
                    <li class='nav_first'><a href="#" class='nav_a'>Sell on Tesco</a></li>
                    <li><a href="#" class='nav_a'>Become an Affiliate</a></li>
                    <li><a href="#" class='nav_a'>Fulfilment by Tesco</a></li>
                    <li><a href="#" class='nav_a'>Advertise Your Products</a></li>
                    <li class='nav_last'><a href="#" class='nav_a'>Tesco Pay on Merchants</a></li>
                </ul>
            </td>
            <td class="navFooterColSpacerInner"></td>
            <td class="navFooterLinkCol">
                ...
                <ul>
                    ...
                    <li><a href="#" class='nav_a'>Tesco Assistant</a></li>
    ...
    <div class="navFooterLine navFooterLogoLine">
        <a href="#">
            <img src="../images/logo_small.png" alt="Tesco">
    ...
    <div class="navFooterLine navFooterLinkLine navFooterDescLine">
        <table class="navFooterMoreOnTesco" cellspacing="0">
            <tr>
                ...
                <td class="navFooterDescItem"><a href="#" class='nav_a'>Tesco Web Services<br/> <span
            ...
            <tr>
                ...
                <td class="navFooterDescItem"><a href="#" class='nav_a'>
                    Tesco Business<br/> <span class="navFooterDescText">Everything For<br/> Your Business</span></a>
                </td>
                <td class="navFooterDescSpacer" style="width: 4%"></td>
                ...
                <td class="navFooterDescSpacer" style="width: 4%"></td>
                <td class="navFooterDescItem"><a href="#" class='nav_a'>Tesco Now<br/> <span class="navFooterDescText"> 2-Hour Delivery<br/> on Everyday Items</span></a>
                </td>
                <td class="navFooterDescSpacer" style="width: 4%"></td>
    ...
    <div class="navFooterLine navFooterLinkLine navFooterPadItemLine navFooterCopyright">
        ...
        <span>© 1996-2018, Tesco.com, Inc. or its affiliates</span>
        <ul></ul>
    </div>
</div>
